...
#SBATCH --time=22:0:0
#SBATCH --job-name=rebinning_checkM
#SBATCH --output=%x.out
...
out_path="${project_path}/re_binning_all_TS/checkM"
...
checkm qa ${out_path}/lineage.ms -o 2 -f ${out_path}/checkm.out ${out_path} --tab_table
