...
# binning commands 
singularity exec ${project_path}/51366-apps-new.sif jgi_summarize_bam_contig_depths --outputDepth ${out_path}/${assembly_name}-depth.txt ${mapping_dir}/*-vs-${assembly_name}*.sorted.bam
